...
class TransE_set(BaseModel):
    def __init__(self, **kwargs):
        ...
        self.params = {'e': LookupParameter(name='e', shape=(self.n_entity, self.dim), init_method = 'set'),
                       'r': LookupParameter(name='r', shape=(self.n_relation, self.dim), init_method = 'xavier')}
